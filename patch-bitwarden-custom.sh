...
if [ ! -f "$SCRIPT_BASE/bwdata/bitbetter/bitbetter.cer" ]; then
...
then
    ...
    yq -i eval '.services.api.volumes = ["../bitbetter/bitbetter.cer:/bitbetter/certs/bitbetter.cer"]'  bwdata/docker docker-compose.override.yml
    ...
    yq -i eval '.services.identity.volumes = ["../bitbetter/bitbetter.cer:/bitbetter/certs/bitbetter.cer"]' bwdata/docker docker-compose.override.yml
